...
namespace pdj.tiny7z.Compression.BCJ
{
    internal abstract class AbstractFilter : Stream
    {
        ...
        protected AbstractFilter(bool isEncoder, Stream baseStream, int lookahead)
        {
