...
{
    class LzmaSdkDecoderStream : DecoderStream
    {
        ...
        public LzmaSdkDecoderStream(Stream input, byte[] info, long limit)
        {
            mInputStream = input;
            mTotalRead = 0;
            mLimit = limit;
            ...
            mDecoder.CodeStart(mInputStream, mBufferStream, input.Length, limit);
        }
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            while (count > 0)
            {
                ...
                else
                {
                    ...
                    mDecoder.CodeContinue(checked((ulong)count));
